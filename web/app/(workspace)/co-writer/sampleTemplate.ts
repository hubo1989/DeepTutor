...
export const CO_WRITER_SAMPLE_TEMPLATE = `# LearnLeader Co-Writer

> LearnLeader's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for LearnLeader product docs and learning content

## Headers (Underline)

LearnLeader Learning Note
=============

LearnLeader Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers LearnLeader while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> LearnLeader helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [LearnLeader](#deeptutor-co-writer)

### Links

[LearnLeader Co-Writer](#deeptutor-co-writer "co-writer section")

[LearnLeader Learning Note](#deeptutor-learning-note)

[LearnLeader Website](https://deeptutor.info)
...
> LearnLeader brand mark used inside the co-writer template.

### Lists

- LearnLeader Chat
- LearnLeader Co-Writer
- LearnLeader Research
...
- [x] Draft a LearnLeader product note
...
op=>operation: LearnLeader analyzes intent
...
${FENCE}seq
Student->LearnLeader: Ask for help
LearnLeader->KnowledgeBase: Load context
Note right of LearnLeader: Collect memory\\nand relevant knowledge
LearnLeader-->Student: Return guided response
Student->>LearnLeader: Request rewrite in co-writer
${FENCE}
