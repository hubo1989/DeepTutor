...
export default function FilePreviewDrawer({
  ...
  return (
    <div
      ...
      // Full-screen sheet below the desktop breakpoint, matching
      // SessionViewerPanel — a 92vw overlay on a phone or portrait tablet is
      // an awkward near-miss rather than a usable second column.
      className={`fixed right-0 top-0 z-[30] flex h-dvh w-full flex-col border-l border-[var(--border)] bg-[var(--card)] transition-transform ease-out lg:w-[min(560px,92vw)] ${
