...
const AGENT_CHILDREN: SettingsLeaf[] = [
  {
    ...
    blurb: {
      zh: "导学吧调用本机 Claude Code 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "导学吧调用本机 Codex 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "导学吧调用本机 Gemini CLI 时的模型与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "导学吧调用本机 opencode 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "导学吧调用本机 MiMo Code 时的模型、推理强度与运行参数。",
